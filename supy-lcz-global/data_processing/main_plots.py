...
ds.T2.isel(timestamp=0).plot.pcolormesh()
...
shapefile = gpd.read_file(r"C:\Users\Danish\Documents\GitHub\UrbClimUGdissert\supy-lcz-global\data\GreaterKL-2017_Y1_M2sp_3sf_R1_s1\input\grid\roi_grid.shp")
print(shapefile)
