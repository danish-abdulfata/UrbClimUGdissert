...
- background of site of study

### Figures and other content needed
- check anno bibliography for literature view paper
- flowchart of model process
- area of study figures
	-> qGIS or some alternative python geospatial package
...
- Summary statistics and statistical testing?
	-> find out what sort of validation testing can be done?
